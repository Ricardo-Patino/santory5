...
public class verDetalle implements Serializable { //serializacion porque se va almacenar ciertos datos en el disco
    ...
    public verDetalle(String descripcion, boolean activo) {
