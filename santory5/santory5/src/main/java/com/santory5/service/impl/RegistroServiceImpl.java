...
import com.santory5.service.CorreoService;
import com.santory5.service.RegistroService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    @Autowired
    private FirebaseStorageServiceImpl firebaseStorageService;  //agrega foto de usuario
    ...
    public Model activar(Model model, String username, String clave) {
        ...
        if (usuario != null) {
            ...
            model.addAttribute(    //lo que muestra en el correo
                    "titulo", 
    ...
    private String demeClave() {
        ...
        String clave = "";
        for (int i = 0; i < 40; i++) {
            clave += tira.charAt((int) (Math.random() * tira.length())); //crea clave random
        }
        return clave;
    }
